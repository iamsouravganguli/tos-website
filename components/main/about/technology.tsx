...
export function TechnologiesSection() {
  return (
    <section className="flex flex-col md:flex-row items-center justify-between bg-white text-black px-6 md:px-12 min-h-screen py-16" id="technologies">
      {/* Text Content */}
      <div className="flex-1 max-w-2xl space-y-4 md:space-y-6 mx-4 md:mx-20">
        <h2 className="text-4xl md:text-6xl font-bold leading-tight mb-4 md:mb-6">Technologies we use</h2>
