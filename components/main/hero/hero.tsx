...
export function Hero() {
  ...
  return (
    <section className="bg-sky-50 pt-16">
      <div className="max-w-screen-xl flex items-center mx-auto flex-col lg:flex-row pt-10 sm:pt-10 pb-10 px-4 sm:px-8 md:px-4 xl:px-0">
        <div className="flex flex-col pt-0 mb-16 lg:flex-grow w-full lg:w-3/5 xl:w-1/2 pr-10 lg:pr-0 xl:pr-10 items-start text-left md:mb-0 ">
          <div className="text-black title-font mb-2 sm:mb-3 md:mb-5 leading-none text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-main-title text-left font-extrabold text-gray-900 ">
            Shaping ideas
          </div>
          <div className="text-black title-font mb-4 sm:mb-6 md:mb-8 leading-none text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-main-title text-left font-extrabold text-gray-900 ">
            into products
          </div>
