  ...
  return (
    <section className="text-gray-900 body-font bg-[url('/assets/bg-pattern.svg')] bg-center bg-repeat-x">
      <div className="max-w-screen-lg mx-auto">
        <div className="flex flex-col justify-center px-4 sm:px-8 md:px-4 xl:px-0 pb-10 sm:pb-20 md:pb-20 lg:pb-52 pt-10 sm:pt-24 md:pt-28 lg:pt-32 items-center">
          <div className="font-extrabold leading-none text-3xl sm:text-4xl md:text-5xl lg:text-title text-center">
            Serving the clients
          </div>
          <div className="font-extrabold leading-none text-3xl sm:text-4xl md:text-5xl lg:text-title text-center">
