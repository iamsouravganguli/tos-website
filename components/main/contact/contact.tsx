    ...
    <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
        <div>
            ...
            <ul className="mt-12 space-y-8">
                <li className="flex items-center">
                    ...
                    <a href="javascript:void(0)" className="text-gray-600 text-sm ml-4">
                        info@example.com
                    </a>
                </li>
                <li className="flex items-center">
            ...
            <ul className="flex mt-12 space-x-4">
                <li className="bg-medium hover:bg-medium-light h-10 w-10 rounded-full flex items-center justify-center shrink-0">
        ...
        <div className="bg-slate-100 p-6 rounded-lg">
            ...
            <div className="space-y-4 max-lg:mt-4">
                <button type="button" className={`px-4 py-2 rounded-lg   ${activeButton === "Web Design" ? "text-white bg-medium " : "text-gray-600 bg-transparent border-gray-300"} text-sm tracking-wider font-medium outline-none border-2  mr-4`} onClick={() => {handleInterestClick("Web Design")}}>Web design</button>
                <button type="button" className={`px-4 py-2 rounded-lg  ${activeButton === "Graphic Design" ? "text-white bg-medium" : "text-gray-600 bg-transparent border-gray-300"}  text-sm tracking-wider font-medium outline-none border-2  mr-4`}  onClick={() => {handleInterestClick("Graphic Design")}}>Graphic design</button>
                <button type="button" className={`px-4 py-2 rounded-lg ${activeButton === "AI Bots" ? "text-white bg-medium" : "text-gray-600 bg-transparent border-gray-300"} text-sm tracking-wider font-medium outline-none border-2 `}  onClick={() => {handleInterestClick("AI Bots")}}>AI Bots</button>
            </div>
            ...
            <form className="mt-8 space-y-4">
                ...
                <button type='button'
                    className="text-white bg-medium hover:bg-medium-light tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
